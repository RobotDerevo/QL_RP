///Minimap Code
SColor color_sky = SColor(0xffBACFD9);
SColor color_dirt = SColor(0xffEDA95A);
SColor color_dirt_backwall = SColor(0xff3B1406);
SColor color_stone = SColor(0xffEDA95A);
SColor color_thickstone = SColor(0xffEDA95A);
SColor color_gold = SColor(0xffEDA95A);
SColor color_bedrock = SColor(0xff303B30);
