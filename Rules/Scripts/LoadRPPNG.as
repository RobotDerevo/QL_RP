...
class RPPNGLoader : PNGLoader
{
	...
	void handlePixel(const SColor &in pixel, int offset) override
	{
		...
		switch (pixel.color)
		{
			...
			case rp_colors::orange: autotile(offset); spawnBlob(map, "tent", offset, 4); break;
			case rp_colors::red: autotile(offset); spawnBlob(map, "tent", offset, 1); break;
			case rp_colors::green: autotile(offset); spawnBlob(map, "tent", offset, 2); break;
			case rp_colors::blue: autotile(offset); spawnBlob(map, "tent", offset, 0); break;
			case rp_colors::lb: autotile(offset); spawnBlob(map, "tent", offset, 5); break;
			case rp_colors::darkpurple: autotile(offset); spawnBlob(map, "tent", offset, 6); break;
			case rp_colors::purple: autotile(offset); spawnBlob(map, "tent", offset, 3); break;
